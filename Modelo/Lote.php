...
class Lote{
    ...
    function buscar(){
		if(!empty($_POST['consulta'])){
			...
			$sql="SELECT id_lote,stock, vencimiento, concentracion, adicional, producto.nombre as prod_nom, empresa.nombre as emp_nom, tipo_producto.nombre as tipo_nom, presentacion.nombre as pre_nom, proveedor.nombre as proveedor,  producto.avatar as logo FROM lote
            join proveedor on lote_id_prov=id_proveedor
            join producto on lote_id_prod=id_product
